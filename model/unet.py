...
class UNet(nn.Module):
    '''
    During the training, the ground truth of each sample is given by two binary masks. After the training, the network predicts for each pixel four proximity values of being/not being a marker, and being/not being a cell mask.
